...
if [ "$1" = 'default' ]; then
  ...
  if [ -n "${TAIGA_BACKEND_DEBUG}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_DEBUG#${TAIGA_BACKEND_DEBUG}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_ADMIN_NAME}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_ADMIN_NAME#${TAIGA_BACKEND_ADMIN_NAME}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_ADMIN_EMAIL}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_ADMIN_EMAIL#${TAIGA_BACKEND_ADMIN_EMAIL}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_POSTGRESQL_HOST}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_POSTGRESQL_HOST#${TAIGA_BACKEND_POSTGRESQL_HOST}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_POSTGRESQL_PORT}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_POSTGRESQL_PORT#${TAIGA_BACKEND_POSTGRESQL_PORT}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_POSTGRESQL_NAME}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_POSTGRESQL_NAME#${TAIGA_BACKEND_POSTGRESQL_NAME}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_POSTGRESQL_USER}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_POSTGRESQL_USER#${TAIGA_BACKEND_POSTGRESQL_USER}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_POSTGRESQL_PASS}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_POSTGRESQL_PASS#${TAIGA_BACKEND_POSTGRESQL_PASS}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_CELERY_ENABLED}" ]; then
    echo "TAIGA_BACKEND_CELERY_ENABLED: \"${TAIGA_BACKEND_CELERY_ENABLED}\""
    sed -i -e "s#TAIGA_BACKEND_CELERY_ENABLED#${TAIGA_BACKEND_CELERY_ENABLED}#" local.py
  else
    echo "Set require environment variable: TAIGA_BACKEND_CELERY_ENABLED"
    exit 1
  fi
  ...
  if [ -n "${TAIGA_BACKEND_RABBITMQ_USER}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_RABBITMQ_USER#${TAIGA_BACKEND_RABBITMQ_USER}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_RABBITMQ_PASS}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_RABBITMQ_PASS#${TAIGA_BACKEND_RABBITMQ_PASS}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_RABBITMQ_HOST}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_RABBITMQ_HOST#${TAIGA_BACKEND_RABBITMQ_HOST}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_RABBITMQ_PORT}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_RABBITMQ_PORT#${TAIGA_BACKEND_RABBITMQ_PORT}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_RABBITMQ_PATH}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_RABBITMQ_PATH#${TAIGA_BACKEND_RABBITMQ_PATH}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_SITES_API_SCHEME}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_SITES_API_SCHEME#${TAIGA_BACKEND_SITES_API_SCHEME}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_SITES_API_DOMAIN}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_SITES_API_DOMAIN#${TAIGA_BACKEND_SITES_API_DOMAIN}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_SITES_API_PORT}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_SITES_API_PORT#${TAIGA_BACKEND_SITES_API_PORT}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_SITES_FRONT_SCHEME}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_SITES_FRONT_SCHEME#${TAIGA_BACKEND_SITES_FRONT_SCHEME}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_SITES_FRONT_DOMAIN}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_SITES_FRONT_DOMAIN#${TAIGA_BACKEND_SITES_FRONT_DOMAIN}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_SITES_FRONT_PORT}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_SITES_FRONT_PORT#${TAIGA_BACKEND_SITES_FRONT_PORT}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_MEDIA_URL}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_MEDIA_URL#${TAIGA_BACKEND_MEDIA_URL}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_STATIC_URL}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_STATIC_URL#${TAIGA_BACKEND_STATIC_URL}#" local.py
  else
  ...
  if [ -n "${TAIGA_BACKEND_SECRET_KEY}" ]; then
    ...
    sed -i -e "s#TAIGA_BACKEND_SECRET_KEY#${TAIGA_BACKEND_SECRET_KEY}#" local.py
  else
